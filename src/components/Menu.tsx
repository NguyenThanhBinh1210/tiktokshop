          ...
          <div className='bg-white  w-full rounded-xl p-2.5'>
            <div className='flex items-center gap-5'>
              ...
              <div className='text-gray-500 space-y-2'>
                ...
                <div className='text-lg font-medium flex items-center '>
                  Tín nhiệm: <div className='bg-primary h-0.5 w-6 rounded-full ml-4'> </div><div className='text-white bg-primary rounded-full  py-1 text-xs px-3'>100%</div>
                </div>
            ...
            <div className='grid grid-cols-2 mt-3 mb-3'>
              <div className='border-r-2'>
                <p className='text-[#003857] font-bold text-2xl'>
                  $0.00
                </p>
